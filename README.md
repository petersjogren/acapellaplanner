...
3. **Mark a phrase** on the ghost — musical sentences and breaths, not arbitrary bars. Click a marked phrase to select it; Option-click to play it. Name them; add lyrics if you have them.
